        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UiMetadata = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldDefinitions_TenantId_EntityType",
                table: "FieldDefinitions",
                columns: new[] { "TenantId", "EntityType" });

            migrationBuilder.CreateIndex(
                name: "IX_FieldDefinitions_TenantId_EntityType_DisplayOrder",
                table: "FieldDefinitions",
                columns: new[] { "TenantId", "EntityType", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_FieldDefinitions_TenantId_EntityType_FieldKey",
                table: "FieldDefinitions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Nodes_TenantId_CreatedAt",
                table: "Nodes",
                columns: new[] { "TenantId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Nodes_TenantId_Type",
                table: "Nodes",
